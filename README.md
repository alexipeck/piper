...
- `Piper` is the managed linear pipeline harness with live outputs, dynamic worker scaling, pull-based telemetry, graceful shutdown, abort, and reusable internal buffer leases.
